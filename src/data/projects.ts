...
export const projects: any[] = [
  ...
  },
  {
    ...
    number: '06',
    title: 'IXL x JHU',
    subtitle: 'Exploring a Virtual Reality Representation of the Mission Control Center with an Intelligent Virtual Agent for NASA\'s Space Operations',
    semester: 'Fall 2025 – Spring 2026',
    client: 'Johns Hopkins APL',
    sponsor: 'Johns Hopkins APL',
    teamSize: '7 People',
    focus: 'UX Research Operations',
    myRole: 'UX Designer / Research Lead',
    roleBadge: 'UX Designer / Research Lead',
    bgClass: 'banner-theme-capstone',
    tagColor: 'bg-[#f5c800] text-dark',
    projectType: 'Capstone Project',
    overview: 'This year-long capstone became one of my most meaningful projects at Purdue. I served as UX Designer and Research Lead for a cross-disciplinary team working with Johns Hopkins Applied Physics Lab on a virtual reality representation of Mission Control with an intelligent virtual agent for NASA\'s space operations. I led major portions of research operations from SME outreach through synthesis, testing, and final communication deliverables.',
    teamwork: 'Our team navigated early institutional pushback that threatened the project timeline, and that challenge strengthened how we collaborated with each other, our professor, and our sponsor. Because this was not a full UX-only team, I adapted my workflow to collaborate across different majors and often worked in smaller subgroups while keeping the larger research process coordinated and moving forward.',
    quote: '"This project pushed me to grow as both a researcher and teammate. We kept going through uncertainty, built momentum together, and produced work we were proud to stand behind."',
    teamworkBullets: [
      'Led interviewing and research compilation with high-level SMEs including Flight Directors, Astronauts, Flight Controllers, and UI/UX and engineering specialists.',
      'Maintained an active interview operations tracker with participant status, role context, and protocol readiness across a fast-moving schedule.',
      'Synthesized findings from 11 SME participants and translated the research into structured written inputs that supported model development and evaluation.',
      'Co-created and delivered project communication artifacts including a conference poster, project video, and an academic paper with the team.'
    ],
    challenge: 'The project required balancing high research rigor with ambiguity, shifting constraints, and a cross-disciplinary team structure. Alongside complex scheduling and stakeholder coordination, we had to preserve consistency across interviews, testing, and synthesis while proving project value through public and academic deliverables.',
    process: [
      { num: '01', title: 'SME Recruitment & Coordination', desc: 'Planned and managed outreach, scheduling, and protocol readiness for a broad set of subject matter experts across mission-control-related roles.' },
      { num: '02', title: 'Interviewing & Data Capture', desc: 'Conducted and supported interview sessions focused on mission-control workflows, constraints, and opportunities for virtual and intelligent support systems.' },
      { num: '03', title: 'Synthesis & System Inputs', desc: 'Synthesized insights from 11 participants and converted findings into structured written formats to support the AI model and virtual environment direction.' },
      { num: '04', title: 'Testing & Dissemination', desc: 'Created user testing protocols for the functional VR and agent experience, then communicated findings through a project video, academic paper, and Purdue OUR poster presentation.' }
    ],
    media: [
      { type: 'image', src: withBase('/images/Capstone/capstone-group-poster.jpg'), caption: 'Team with conference poster' },
      { type: 'image', src: withBase('/images/Capstone/apl-shirts-group.jpg'), caption: 'APL team shirts and challenge coins' },
      { type: 'image', src: withBase('/images/Capstone/poster-full-closeup.jpg'), caption: 'Capstone poster full view', fullWidth: true },
      { type: 'image', src: withBase('/images/Capstone/interview-session-bw.jpg'), caption: 'Interview preparation session' },
      { type: 'image', src: withBase('/images/Capstone/avery-with-poster.jpg'), caption: 'Avery with final poster' },
      { type: 'video', src: 'https://www.youtube.com/embed/LH1G0Wwj9_8?rel=0', link: 'https://www.youtube.com/watch?v=LH1G0Wwj9_8', caption: 'Capstone Video Presentation', fullWidth: true },
      { type: 'pdf', src: withBase('/images/Capstone/capstone-paper.pdf'), caption: 'Capstone research paper', fullWidth: true }
    ]
  }
];
